...
//   // we need to delete previous render result 
//   tbody.innerHTML ="";
...
//     const subject = document.querySelector("#subject").value;
//     const marks = document.querySelector("#marks").value;
//     const markedby = document.querySelector("#markedby").value;
//     const rowId = document.querySelector("#rowId").textContent;
//     const saveTd = document.querySelector("#save-td");
...
//     const td = document.createElement('td');
//     const element = document.createElement(data.name);// span
//     element.id = data.id;
//     element.type = data.type;
...
//     if(data.name == 'button'){
//         element.textContent = data.text;
//         // console.log("on click",data.onclick);
//         element.onclick = data.onClick;
//     }
